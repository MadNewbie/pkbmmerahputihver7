...
var _data = window["_eventIndexData"];
...
var methods = {
  getData: function getData() {
    ...
    return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var clickedPage, url, dataContainer, page, response, data, eventData, pagination;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              clickedPage = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : null;
              url = _data.routeIndexData;
              dataContainer = document.getElementById('data-container'); //reset data
            ...
            case 7:
              ...
              eventData.forEach(function (data) {
                var eventThumbImg = document.createElement('img');
                ...
                var eventTitleRow = document.createElement('div');
                ...
                var col8Card = document.createElement('div');
                col8Card.classList.add('col-lg-8');
                col8Card.append(eventContainer);
                var col4Card = document.createElement('div');
                ...
                var eventLinkDetail = document.createElement('a');
  ...
  linkPaginationListener: function linkPaginationListener(id) {
    this.getData(id);
  },
  renderPagination: function renderPagination(data) {
    var _this2 = this;
    ...
    if (data.curPage != data.maxPage) {
      var _nextLink2 = document.createElement('button');

      _nextLink2.append('>');

      _nextLink2.addEventListener('click', function (e) {
        return _this2.getData(data.nextPage);
      });

      paginationLinks.push(_nextLink2);
    }
...
module.exports = __webpack_require__(/*! /var/www/html/merahputih2/resources/js/event.js */"./resources/js/event.js");
